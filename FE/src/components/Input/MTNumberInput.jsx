...
const MTNumberInput = ({ amountWant, setAmountWant }) => {
  return (
    <>
      <div className='relative w-full'>
        <Input
          type='number'
          value={amountWant}
          onChange={(e) => setAmountWant(Number(e.target.value))}
        ...
        <div className='absolute right-1 top-1 flex gap-0.5'>
          <IconButton
            ...
            variant='text'
            className='rounded'
            onClick={() => setAmountWant((cur) => (cur === 0 ? 0 : cur - 1))}
          >
            <svg
          ...
          <IconButton
            ...
            variant='text'
            className='rounded'
            onClick={() => setAmountWant((cur) => cur + 1)}
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 16 16'
